...
import net.MarkustheSlime.twosidesmod.screen.renderer.EnergyInfoArea;
import net.MarkustheSlime.twosidesmod.screen.renderer.FluidTankRenderer;
import net.MarkustheSlime.twosidesmod.util.MouseUtil;
...
public class DmTableScreen extends AbstractContainerScreen<DmTableMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(TwoSidesMod.MOD_ID,"textures/gui/dm_table_gui.png");
    private FluidTankRenderer renderer;
    private EnergyInfoArea energyInfoArea;

    public DmTableScreen(DmTableMenu menu, Inventory inventory, Component component) {
