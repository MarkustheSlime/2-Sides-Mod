...
public class DmTableBlockEntityRenderer implements BlockEntityRenderer<DmTableBlockEntity> {
    public DmTableBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(DmTableBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
        ...
        switch (pBlockEntity.getBlockState().getValue(DMTABLEBLOCK.FACING)) {
