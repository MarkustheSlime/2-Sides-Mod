...
public class PrimalMatrixBlockEntity extends BlockEntity implements IAnimatable{
        ...
        public PrimalMatrixBlockEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.PRIMAL_MATRIX_TILE.get(), pos, state);
        }
