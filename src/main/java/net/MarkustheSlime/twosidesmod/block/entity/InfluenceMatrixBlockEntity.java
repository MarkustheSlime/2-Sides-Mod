...
public class InfluenceMatrixBlockEntity extends BlockEntity implements IAnimatable{
        ...
        public InfluenceMatrixBlockEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.INFLUENCE_MATRIX_TILE.get(), pos, state);
        }
