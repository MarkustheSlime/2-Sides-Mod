...
public class ControlMatrixBlockEntity extends BlockEntity implements IAnimatable{
        ...
        public ControlMatrixBlockEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.CONTROL_MATRIX_TILE.get(), pos, state);
        }
