...
public class LifeMatrixBlockEntity extends BlockEntity implements IAnimatable{
        ...
        public LifeMatrixBlockEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.LIFE_MATRIX_TILE.get(), pos, state);
        }
