...
public class SoulMatrixBlockEntity extends BlockEntity implements IAnimatable{
        ...
        public SoulMatrixBlockEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.SOUL_MATRIX_TILE.get(), pos, state);
        }
