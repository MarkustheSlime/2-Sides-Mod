...
public class PowerMatrixBlockEntity extends BlockEntity implements IAnimatable{
        ...
        public PowerMatrixBlockEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.POWER_MATRIX_TILE.get(), pos, state);
        }
