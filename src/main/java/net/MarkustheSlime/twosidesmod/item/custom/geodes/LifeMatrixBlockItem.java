...
public class LifeMatrixBlockItem extends BlockItem implements IAnimatable {

    public AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public String controllerName = "controller";

    public LifeMatrixBlockItem(Block p_i48527_1_, Properties p_i48527_2_) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            private final BlockEntityWithoutLevelRenderer renderer = new LifeMatrixBlockItemRenderer();
