...
public class SoulArmorItem extends GeoArmorItem implements IAnimatable {

    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP1 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorTiers.SOUL, new MobEffectInstance(MobEffects.INVISIBILITY, 20, 0)).build();

    public SoulArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties settings) {
        super(materialIn, slot, settings);
    }

    @Override
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<SoulArmorItem>(this, "controller",
                20, this::predicate));
    }
