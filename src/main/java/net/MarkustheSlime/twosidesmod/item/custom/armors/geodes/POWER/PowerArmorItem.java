...
public class PowerArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP1 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorTiers.POWER, new MobEffectInstance(MobEffects.DAMAGE_BOOST, 20, 1)).build();

    public PowerArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties settings) {
        super(materialIn, slot, settings);
    }

    @Override
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<PowerArmorItem>(this, "controller",
                20, this::predicate));
    }
