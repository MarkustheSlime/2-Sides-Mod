...
public class EarthArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public EarthArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties settings) {
        super(materialIn, slot, settings);
    }

    @Override
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<EarthArmorItem>(this, "controller",
                20, this::predicate));
    }
