...
public class SunWoodArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorTiers.SUN_WOOD, new MobEffectInstance(MobEffects.GLOWING, 999999, 1)).build();
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP2 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorTiers.SUN_WOOD, new MobEffectInstance(MobEffects.JUMP, 999999, 1)).build();
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP3 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorTiers.SUN_WOOD, new MobEffectInstance(MobEffects.SLOW_FALLING, 999999, 1)).build();
