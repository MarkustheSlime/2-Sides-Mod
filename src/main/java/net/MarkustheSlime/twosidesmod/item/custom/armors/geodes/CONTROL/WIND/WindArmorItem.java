...
public class WindArmorItem extends GeoArmorItem implements IAnimatable {

    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP1 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorTiers.CONTROL, new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 20, 1)).build();
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP4 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorTiers.CONTROL, new MobEffectInstance(MobEffects.BLINDNESS, 1200, 0)).build();
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP5 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorTiers.CONTROL, new MobEffectInstance(MobEffects.DIG_SPEED, 20, 0)).build();

    public WindArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties settings) {
        super(materialIn, slot, settings);
    }

    @Override
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<WindArmorItem>(this, "controller",
                20, this::predicate));
    }
