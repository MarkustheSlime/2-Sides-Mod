...
public class FireArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP4 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorTiers.CONTROL, new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 20, 1)).build();

    public FireArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties settings) {
        super(materialIn, slot, settings);
    }

    @Override
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<FireArmorItem>(this, "controller",
                20, this::predicate));
    }
