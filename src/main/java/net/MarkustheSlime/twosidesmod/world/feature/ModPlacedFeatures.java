...
public class ModPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> RainbowFlower_PLACED = PLACED_FEATURES.register("rainbow_flower_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.RainbowFlower.getHolder().get(), List.of(RarityFilter.onAverageOnceEvery(16),
