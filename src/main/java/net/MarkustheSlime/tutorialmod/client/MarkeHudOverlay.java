...
public class MarkeHudOverlay {
    private static final ResourceLocation FILLED_ENERGY = new ResourceLocation(Tutorialmod.MOD_ID,
            "textures/marke_energy/filled_energy.png");
    private static final ResourceLocation EMPTY_ENERGY = new ResourceLocation(Tutorialmod.MOD_ID,
